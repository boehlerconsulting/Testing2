...
export default class MassenzuweisungAufgaben extends LightningElement {

    @api iconName = 'standard:task';
    @api title = 'Massenzuweisung von Aufgaben';
    @api sortBy = 'Aufgabenart__c';
            ...
            saveRecords({
                ...
                .then(result => {
                    ...
                    this.dispatchEvent(
                        new ShowToastEvent({
                            title: 'Erfolg',
                            message: 'Die Aufgabe(n) wurden erfolgreich gespeichert.',
                            variant: 'success',
                        }));
    ...
    handleOnChangeZugeordnetZu(event) {
        this.showSpinner = true;
        this.zugeordnetZu = event.detail.value;
        this.loadData();
    }

    handleOnChangeAufgabenart(event) {
        this.showSpinner = true;
        this.aufgabenart = event.detail.value;
        this.loadData();
    }
    ...
    handleOnChangeDebitor(event) {
        this.showSpinner = true;
        this.debitor = event.detail.value;
        this.loadData();
    }

    handleOnChangeErledigungBisZum(event) {
        this.showSpinner = true;
        this.erledigungBisZum = event.detail.value;
        this.loadData();
    }
